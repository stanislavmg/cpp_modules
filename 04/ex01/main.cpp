...
int main()
{
	...
	brain->setIdea(1, "That's a strange idea I'm having");
	brain->setIdea(2, "Ball!!!!!");
	brain->setIdea(3, "Squirrel!!!!!");
	...
	*(animals[5]) = *(animals[7]);
	...
	animals[5]->getBrain()->setIdea(4, "Last idea of animals[5]");
	std::cout << "Last idea of animal[5]: " << animals[5]->getBrain()->getIdea(4) << std::endl;
	animals[7]->getBrain()->setIdea(5, "Last idea of animals[7]");
