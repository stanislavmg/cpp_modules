...
int main()
{
	...
	{
		std::cout << "Cannot create Thor:" << e.what() << std::endl;
	}
	...
	{
		std::cout << "Cannot create John:" << e.what();
	}
	...
	{
		std::cout << "Cannot increment the grade of Odin: " << e.what() << std::endl;
	}
	...
	{
		std::cout << "Cannot decrement the grade of Loki: " << e.what() << std::endl;
	}
}